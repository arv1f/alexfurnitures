export default function ContainerInfo4() {
  return (
    <div className="grid grid-rows-[5%_38%_7%_10%] md:grid-rows-[7%_28%_7%_10%] lg:grid-rows-[5%_75%] lg:grid-cols-[50%_auto] gap-4 lg:max-h-[680px]">
        <div className="row-start-4 lg:row-start-1 col-start-1 w-full h-[680px] bg-[url('a_modern_professional_office_building_exterior_representing_-_furniture_company_the_image_should_co_i5qw5pw5y52xpm5f88pe_2.png')] rounded-[20px] overflow-hidden">
          ...
          leading-[135%] tracking-[0.02em] text-[#333333] self-stretch text-nowrap">О компании</span>
          ...
          <div className="row-start-3 lg:row-start-3 lg:col-start-2 grid grid-rows-2 lg:grid-cols-[42%_42%] gap-1">
            ...
            w-[180px] lg:w-[90%] max-h-[40px] left-[50px] top-[555px] bg-[#F3BC2B] rounded-[5px] text-white text-sm text-nowrap
          ">Запросить прайс</button>
          <button className="
            flex flex-row items-center justify-center p-[16px_24px] gap-2
            w-[180px] lg:w-[90%] max-h-[40px] left-[50px] top-[555px] bg-[#FFFFFF] text-[#F3BC2B] border-2 border-[#F3BC2B] rounded-[5px]
          ">Подробнее</button>
          </div>
    </div>
  );
