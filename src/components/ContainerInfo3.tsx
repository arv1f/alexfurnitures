export default function ContainerInfo3() {
  return (
    ...
    grid-rows-[0_25%_25%_25%_25%] md:grid-rows-[0_50%_50%] lg:grid-rows-[20%_auto]">
      ...
      leading-[135%] tracking-[0.02em] text-[#333333] self-stretch text-nowrap">Почему мы?</span>
...
const BoxInfo = ({sequence, description}:BoxInfoI) =>{
  return(
    <div className="p-[30px] pt-[20px] xl:pt-[30px] w-[95%] h-[238px] mt-[93px] lg:mt-[30px] mb-[10px] bg-white shadow-[0_0_12px_#E3E3E3] rounded-[20px]">
          <div className="w-[70px] h-[68px] left-[30px] top-[20px] font-bold text-[50px] lg:text-4xl leading-[135%] text-[#F3BC2B]">{sequence}</div>
          <div className="w-[100%] h-[70px] left-[30px] top-[93px] font-bold text-[23px] lg:text-sm leading-[150%] text-[#212121]">{description}</div>
    </div>
  );
};